  ...
  {{ dd(Auth::user()) }}
    ...
    <section>
        <div class="container px-5 pt-12 pb-6 mx-auto">
          <div class="flex items-center lg:w-4/5 mx-auto border-b-2 pb-10 mb-10 border-princeton-orange sm:flex-row flex-col">
            <div class="flex-grow items-end sm:text-left text-center mt-6 sm:mt-0">
              <h1 class="text-vermilion text-5xl text-center font-flattery mb-4">About Us</h1>
          ...
          <section>
              <div class="container px-5 pb-16 border-b-2 border-princeton-orange">
                  <h2 class="text-vermilion text-4xl text-center font-flattery mb-8">Meet The Team</h2>
                  <div class="flex flex-wrap -m-4">
                  <div class="lg:w-1/3 lg:mb-0 mb-6 p-4 mx-auto">
                      <div class="h-full text-center">
                          <img alt="testimonial" class="w-20 h-20 object-cover object-center rounded-full inline-block border-2 border-rufous" src="img/owners-victoria.jpg">
                          <br>
                          <span class="inline-block h-1 w-16 rounded bg-princeton-orange mt-6 mb-4"></span>
                      <h2 class="text-vermilion font-cabin font-medium tracking-wider text-xl">VICTORIA</h2>
                      <p class="text-rosewood text-md font-cabin">Your Candle Queen!</p>
                    </div>
                  </div>
                  <div class="lg:w-1/3 lg:mb-0 mb-6 p-4 mx-auto">
                    <div class="h-full text-center">
                      <img alt="testimonial" class="w-20 h-20 object-cover object-center rounded-full inline-block border-2 border-rufous" src="img/owners-candleman.jpg">
                      <br>
                      <span class="inline-block h-1 w-16 rounded bg-princeton-orange mt-6 mb-4"></span>
                      <h2 class="text-vermilion font-cabin font-medium tracking-wider text-xl">CANDLEMAN</h2>
                      <p class="text-rosewood text-md font-cabin">He Packs A Mighty Punch!</p>
                    </div>
                  </div>
                  <div class="lg:w-1/3 lg:mb-0 p-4 mx-auto">
                    <div class="h-full text-center">
                      <img alt="testimonial" class="w-20 h-20 object-cover object-center rounded-full inline-block border-2 border-rufous" src="img/owners-chels-and-wade.jpg">
                      <br>
                      <span class="inline-block h-1 w-16 rounded bg-princeton-orange mt-6 mb-4"></span>
                      <h2 class="text-vermilion font-medium title-font tracking-wider text-xl">CHELSEA & WADE</h2>
          ...
          <div class="flex items-center lg:w-4/5 mx-auto py-10 mb-10 sm:flex-row flex-col">
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-vermilion text-4xl text-center font-flattery mb-4">Our Mission</h2>
